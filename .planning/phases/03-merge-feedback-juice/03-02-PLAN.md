...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <action>
Human verification of the complete merge feedback system. Run the game and verify all feedback channels work as designed.
  </action>
  <what-built>
...
6. (Optional) If achievable: trigger watermelon vanish to see gold burst + big shake + deep sound
  ...
  <verify>Manual playtest per how-to-verify instructions above</verify>
  <done>All merge feedback verification checks pass and human approves via resume-signal</done>
</task>
